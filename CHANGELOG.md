...
This project adheres to [Conventional Commits](https://www.conventionalcommits.org/en/v1.0.0/) for commit message formatting. For detailed guidelines, refer to `CONTRIBUTING.md`.
